    ...
    try:
        ...
        async with acquire_entity_locks(
            ...
            response = await upsert_agent_preview_policy(
                ...
                operation_budgets=req.operation_budgets,
                denied_operations=req.denied_operations,
                max_spend_per_operation=req.max_spend_per_operation,
                remaining_spend_budget=req.remaining_spend_budget,
                audit_actor=admin_actor,
                request_id=request_id,
                client_fingerprint=client_fingerprint,
                reason_code=req.reason_code,
    ...
    try:
        ...
        async with acquire_entity_locks(
            ...
            response = await refill_agent_preview_budget(
                ...
                operation_increments=req.operation_increments,
                spending_credits=req.spending_credits,
                audit_actor=admin_actor,
                request_id=request_id,
                client_fingerprint=client_fingerprint,
                reason_code=req.reason_code,
