...
class Settings(BaseSettings):
    ...
    PREVIEW_COMPANY_INVENTORY_MUTATIONS_PER_WINDOW: int = 40
    PREVIEW_COMPANY_MARKET_MUTATIONS_PER_WINDOW: int = 40
    ...
    CONCURRENCY_MAX_CONCURRENT: int = 25
    CONCURRENCY_STRIPE_COUNT: int = 256
    CONCURRENCY_LOCK_TIMEOUT: float = 5.0
    CONCURRENCY_SLOT_TIMEOUT: float = 10.0
    HOUSEKEEPING_RESERVED_SLOTS: int = 5
    RATE_LIMIT_WINDOW_SECONDS: int = 60
    RATE_LIMIT_AGENT_REQUESTS_PER_WINDOW: int = 120
    RATE_LIMIT_COMPANY_REQUESTS_PER_WINDOW: int = 120
    RATE_LIMIT_ADMIN_REQUESTS_PER_WINDOW: int = 60
    EXECUTION_PHASE_MAX_ATTEMPTS: int = 2
    EXECUTION_JOB_MAX_ATTEMPTS: int = 3
    EXECUTION_JOB_RETRY_DELAY_SECONDS: int = 30
    EXECUTION_JOB_DRAIN_LIMIT: int = 4
    EXECUTION_MAX_BACKFILL_SWEEPS: int = 12
    OBSERVABILITY_SLOW_REQUEST_MS: int = 250
    OBSERVABILITY_SLOW_MCP_MS: int = 250
    OBSERVABILITY_EXECUTION_LAG_WARNING_SECONDS: int = 120
