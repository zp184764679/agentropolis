...
def build_runtime_metadata(*, preview_guard_state: dict | None = None) -> dict:
    ...
    return {
        ...
        "observability_surface": {
            ...
            "thresholds": {
                "slow_request_ms": int(settings.OBSERVABILITY_SLOW_REQUEST_MS),
                "slow_mcp_ms": int(settings.OBSERVABILITY_SLOW_MCP_MS),
                "execution_lag_warning_seconds": int(settings.OBSERVABILITY_EXECUTION_LAG_WARNING_SECONDS),
                "execution_lag_critical_seconds": int(settings.OBSERVABILITY_EXECUTION_LAG_CRITICAL_SECONDS),
                "request_error_warning_rate": float(settings.OBSERVABILITY_REQUEST_ERROR_WARNING_RATE),
                "mcp_failure_warning_rate": float(settings.OBSERVABILITY_MCP_FAILURE_WARNING_RATE),
            },
        ...
        "operator_bundle_surface": {
            ...
            "issue_sync_script": "scripts/export_issue_sync_manifest.py",
            ...
            "cli_commands": [
                ...
                "agentropolis issue-sync-manifest",
                "agentropolis governance-snapshot",
